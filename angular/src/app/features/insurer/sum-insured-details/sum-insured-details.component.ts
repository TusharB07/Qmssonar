...
//   ) {
//     this.quoteId = this.activatedRoute.parent.parent.snapshot.paramMap.get("id");
//   }
...
//   valueUpdated(quoteLocationOccupancyId, lovId, lovType, lovKey, lovReference, id) {
...
//   }
//   nextPage() {
//     this.router.navigateByUrl(`backend/insurer/compare-analyse/${this.quoteId}/request-approval/multilocation-annexure`);
//   }
// }
