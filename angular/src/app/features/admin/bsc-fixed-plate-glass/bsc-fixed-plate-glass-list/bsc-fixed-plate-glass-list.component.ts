...
@Component({
  selector: 'app-bsc-fixed-plate-glass-list',
  templateUrl: './bsc-fixed-plate-glass-list.component.html',
  styleUrls: ['./bsc-fixed-plate-glass-list.component.scss']
})
export class BscFixedPlateGlassListComponent implements OnInit {
  cols: any[];
  ...
  records: IBscFixedPlateGlassCover[];
  /** Represents the user record being deleted. */
  selectedRecord: IBscFixedPlateGlassCover | null = null;
  /** Represents the user records being deleted. */
  selectedRecords: IBscFixedPlateGlassCover[] = [];
  ...
  constructor(private router: Router, private messageService: MessageService, private recordService: BscFixedPlateGlassService, private breadcrumbService: AppBreadcrumbService) {
