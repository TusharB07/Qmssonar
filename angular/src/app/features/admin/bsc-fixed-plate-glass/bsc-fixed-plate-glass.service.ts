...
export class BscFixedPlateGlassService extends CrudService<any> {


    constructor(protected http: HttpClient, protected accountService: AccountService) {
        super(`${environment.apiUrl}/bsc-fixed-plate-glass-cover`, http, accountService, { populate: ['quoteId quoteLocationOccupancyId', 'plateGlassType'] });
    }
