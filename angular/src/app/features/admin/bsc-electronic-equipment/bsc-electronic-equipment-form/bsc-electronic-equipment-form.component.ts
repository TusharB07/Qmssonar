...
@Component({
  selector: 'app-bsc-electronic-equipment-form',
  templateUrl: './bsc-electronic-equipment-form.component.html',
  styleUrls: ['./bsc-electronic-equipment-form.component.scss']
})
export class BscElectronicEquipmentFormComponent implements OnInit {
  ...
  constructor(
    ...
    private recordService: BscElectronicEquipmentService,
  ...
  ngOnInit(): void {
    ...
    if (this.id !== "new") {
      ...
      this.recordService.get(this.id).subscribe({
        next: (dto: IOneResponseDto<IBscElectronicEquipmentsCover>) => {
  ...
  createForm(item?: IBscElectronicEquipmentsCover) {
    ...
    this.recordForm = this.formBuilder.group({
      ...
      descriptionEquipments: [item?.descriptionEquipments],
      sumInsured: [item?.sumInsured,[Validators.min(0)]],
