...
export class BscElectronicEquipmentService extends CrudService<any> {


    constructor(protected http: HttpClient, protected accountService: AccountService) {
        super(`${environment.apiUrl}/bsc-electronic-equipments-cover`, http, accountService, { populate: ['quoteId quoteLocationOccupancyId'] });
    }
