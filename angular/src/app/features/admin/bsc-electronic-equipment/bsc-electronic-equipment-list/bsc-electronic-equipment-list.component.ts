...
import { IBscElectronicEquipmentsCover } from '../bsc-electronic-equipment.model';
import { BscElectronicEquipmentService } from '../bsc-electronic-equipment.service';
...
@Component({
  selector: 'app-bsc-electronic-equipment-list',
  templateUrl: './bsc-electronic-equipment-list.component.html',
  styleUrls: ['./bsc-electronic-equipment-list.component.scss']
})
export class BscElectronicEquipmentListComponent implements OnInit {

  cols: any[];

  recordSingularName = "BSC Electronic Equipment";
  recordPluralName = "BSC Electronic Equipments";
  modulePath: string = "/backend/admin/bsc-electronic-equipments";

  /** Represents the data being displayed currently */
  records: IBscElectronicEquipmentsCover[];
  /** Represents the user record being deleted. */
  selectedRecord: IBscElectronicEquipmentsCover | null = null;
  /** Represents the user records being deleted. */
  selectedRecords: IBscElectronicEquipmentsCover[] = [];
  ...
  constructor(private router: Router, private messageService: MessageService, private recordService: BscElectronicEquipmentService, private breadcrumbService: AppBreadcrumbService) {
  ...
  ngOnInit(): void {
    this.cols = [
      ...
      { field: "descriptionEquipments", header: "Description Equipments" },
