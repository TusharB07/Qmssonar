...
import { BscElectronicEquipmentRoutingModule } from './bsc-electronic-equipment-routing.module';
import { AutoCompleteModule } from 'primeng/autocomplete';


@NgModule({
  declarations: [
    BscElectronicEquipmentListComponent,
    BscElectronicEquipmentFormComponent
  ],
  imports: [
    CommonModule,
    ReactiveFormsModule,
    FormsModule,
    BscElectronicEquipmentRoutingModule,
    ToolbarModule,
    ToastModule,
    TableModule,
    DialogModule,
...
export class BscElectronicEquipmentModule { }
