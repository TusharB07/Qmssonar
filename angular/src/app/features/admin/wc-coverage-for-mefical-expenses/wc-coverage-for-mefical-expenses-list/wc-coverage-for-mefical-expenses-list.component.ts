...
@Component({
  selector: 'app-wc-coverage-for-mefical-expenses-list',
  templateUrl: './wc-coverage-for-mefical-expenses-list.component.html',
  styleUrls: ['./wc-coverage-for-mefical-expenses-list.component.scss']
})
export class WCCoverageForMedicalExpensesListComponent implements OnInit {
  ...
  records: IWCCoverageForMedicalExpenses[];
  /** Represents the coverage Medical Expenses record being deleted. */
  selectedRecord: IWCCoverageForMedicalExpenses | null = null;
  /** Represents the coverage Medical Expenses records being deleted. */
  selectedRecords: IWCCoverageForMedicalExpenses[] = [];
  ...
  constructor(
    ...
    private wcCoverageTypeService: WCCoverageForMedicalExpensesService,
  ...
  loadRecords(event: LazyLoadEvent, name?: string) {
    ...
    this.wcCoverageTypeService.getMany(event).subscribe({
      next: records => {
        console.log(records.data.entities.map((i: IWCCoverageForMedicalExpenses) => [i.limitPerEmployee, i.productId]));
