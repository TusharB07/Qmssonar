...
@Component({
  selector: "app-bsc-discount-list",
  templateUrl: "./bsc-discount-list.component.html",
  styleUrls: ["./bsc-discount-list.component.scss"]
})
export class BscDiscountListComponent implements OnInit {
  cols: any[];
  ...
  records: IBscDiscount[];
  /** Represents the user record being deleted. */
  selectedRecord: IBscDiscount | null = null;
  /** Represents the user records being deleted. */
  selectedRecords: IBscDiscount[] = [];
  ...
  constructor(private router: Router, private messageService: MessageService, private recordService: BscDiscountService, private breadcrumbService: AppBreadcrumbService) {
  ...
  ngOnInit(): void {
    this.cols = [
      { field: "_id", header: "Id" },
      { field: "bscType", header: "BSC Type" },
      { field: "fromSI", header: "From SI" },
      { field: "toSI", header: "To SI" },
      { field: "ratePerMile", header: "Rate per Mile" },
      { field: "productId", header: "Product" },
      { field: "applicable_from", header: "Applicable from" },
      { field: "applicable_to", header: "Applicable to" }
    ];
  }
