...
@Component({
  selector: 'app-bsc-money-safe-till-list',
  templateUrl: './bsc-money-safe-till-list.component.html',
  styleUrls: ['./bsc-money-safe-till-list.component.scss']
})
export class BscMoneySafeTillListComponent implements OnInit {
  ...
  records: IBscMoneySafeTillCover[];
  /** Represents the user record being deleted. */
  selectedRecord: IBscMoneySafeTillCover | null = null;
  /** Represents the user records being deleted. */
  selectedRecords: IBscMoneySafeTillCover[] = [];
  ...
  constructor(private router: Router, private messageService: MessageService, private recordService: BscMoneySafeTillService, private breadcrumbService: AppBreadcrumbService) {
  ...
  ngOnInit(): void {
    this.cols = [
      ...
      { field: "occupancyId", header: "Occupancy" },
      { field: "moneySafe", header: "Money Safe" },
      { field: "moneyTillCounter", header: "Money Till Counter" },
      { field: "total", header: "Total" },
    //   { field: "clientLocationId", header: "Client Location" },
      { field: "quoteLocationOccupancyId", header: "Client Location" },
