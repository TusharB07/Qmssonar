...
export class BusinessTypeService extends CrudService<IBusinessType> {

  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/wcBusinessTypes`, http, accountService, { populate: ['productId', 'partnerId'] })
  }
