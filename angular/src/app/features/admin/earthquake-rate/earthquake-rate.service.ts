...
export class EarthquakeRateService extends CrudService<IEarthquakeRate> {


  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/earthquake-rate-masters`, http, accountService, { populate: ["industryTypeId", "productId", "partnerId", "occupancyId"] });
  }
