...
@Component({
  selector: 'app-quote-location-occupancy-list',
  templateUrl: './quote-location-occupancy-list.component.html',
  styleUrls: ['./quote-location-occupancy-list.component.scss']
})
export class QuoteLocationOccupancyListComponent implements OnInit {
  ...
  records: IQuoteLocationOccupancy[];
  /** Represents the user record being deleted. */
  selectedRecord: IQuoteLocationOccupancy | null = null;
  /** Represents the user records being deleted. */
  selectedRecords: IQuoteLocationOccupancy[] = [];
  ...
  constructor(private router: Router, private messageService: MessageService, private recordService: QuoteLocationOccupancyService, private breadcrumbService: AppBreadcrumbService) {
  ...
  ngOnInit(): void {
    this.cols = [
      ...
      { field: "flexaPremium", header: "Flexa Premium" },
      { field: "STFIPremium", header: "STFI Premium" },
      { field: "earthquakePremium", header: "Earthquake Premium" },
      { field: "terrorismPremium", header: "Terrorism Premium" },
      { field: "totalPremium", header: "Total Premium" },
