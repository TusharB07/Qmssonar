...
import { ValuableContentOnAgreedValueBasisCoverRoutingModule } from './valuable-content-on-agreed-value-basis-cover-routing.module';
...
@NgModule({
  declarations: [
    ValuableContentOnAgreedValueBasisCoverListComponent,
    ValuableContentOnAgreedValueBasisCoverFormComponent
  ],
  imports: [
    CommonModule,
    ValuableContentOnAgreedValueBasisCoverRoutingModule,
    ReactiveFormsModule,
    FormsModule,
    ToolbarModule,
    ToastModule,
...
export class ValuableContentOnAgreedValueBasisCoverModule { }
