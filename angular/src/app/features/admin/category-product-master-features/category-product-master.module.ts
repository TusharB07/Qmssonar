...
import { CategoryProductMasterRoutingModule } from './category-product-master-routing.module';



@NgModule({
  declarations: [
    CategoryProductMasterListComponent,
    CategoryProductMasterFormComponent
  ],
  imports: [
    CommonModule,
    ReactiveFormsModule,
    FormsModule,
    CategoryProductMasterRoutingModule,
    ToolbarModule,
    ToastModule,
    TableModule,
    DialogModule,
...
export class CategoryProductMasterModule { }
