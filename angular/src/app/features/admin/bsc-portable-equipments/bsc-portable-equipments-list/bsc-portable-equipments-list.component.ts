...
@Component({
  selector: 'app-bsc-portable-equipments-list',
  templateUrl: './bsc-portable-equipments-list.component.html',
  styleUrls: ['./bsc-portable-equipments-list.component.scss']
})
export class BscPortableEquipmentsListComponent implements OnInit {
  ...
  records: IBscPortableEquipments[];
  /** Represents the user record being deleted. */
  selectedRecord: IBscPortableEquipments | null = null;
  /** Represents the user records being deleted. */
  selectedRecords: IBscPortableEquipments[] = [];
  ...
  constructor(private router: Router, private messageService: MessageService, private recordService: BscPortableEquipmentsService, private breadcrumbService: AppBreadcrumbService) {
  ...
  ngOnInit(): void {
    this.cols = [
      { field: "_id", header: "Id" },
      { field: "equipmentType", header: "Risk Type" },
      { field: "equipmentDescription", header: "Risk Description" },
