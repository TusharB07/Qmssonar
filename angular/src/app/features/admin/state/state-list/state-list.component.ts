...
export class StateListComponent implements OnInit, OnDestroy {
  ...
  selectedRecord: IState | null = null;
  /** Represents the user records being deleted. */
  selectedRecords: IState[] = [];
  ...
  constructor(private router: Router, private messageService: MessageService, private recordService: StateService, private breadcrumbService: AppBreadcrumbService) {
