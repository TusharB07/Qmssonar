...
import { WCCoverageTypeRoutingModule } from './wc-coverage-type-routing.module';
...
@NgModule({
  declarations: [
    WCCoverageTypeListComponent,
    WCCoverageTypeFormComponent
  ],
  imports: [
    CommonModule,
    WCCoverageTypeRoutingModule,
    ReactiveFormsModule,
    FormsModule,
    ToolbarModule,
    ToastModule,
...
export class WCCoverageTypeModule { }
