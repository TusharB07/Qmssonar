...
export class WCCoverageTypeService extends CrudService<IWCCoverageType> {

  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/wcCoverageTypes`, http, accountService, { populate: ['productId', 'partnerId'] })
  }
