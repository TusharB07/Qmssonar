...
export class DistrictListComponent implements OnInit, OnDestroy {
  ...
  selectedRecord: IDistrict | null = null;
  /** Represents the user records being deleted. */
  selectedRecords: IDistrict[] = [];
  ...
  constructor(private router: Router, private messageService: MessageService, private recordService: DistrictService, private breadcrumbService: AppBreadcrumbService) {
