...
export class SectorListComponent implements OnInit, OnDestroy {
  ...
  selectedRecord: ISector | null = null;
  /** Represents the user records being deleted. */
  selectedRecords: ISector[] = [];
  ...
  constructor(private router: Router, private messageService: MessageService, private recordService: SectorService, private breadcrumbService: AppBreadcrumbService) {
