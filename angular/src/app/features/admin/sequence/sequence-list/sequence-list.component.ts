...
export class SequenceListComponent implements OnInit {
    ...
    selectedRecord: ISequence | null = null;
    /** Represents the user records being deleted. */
    selectedRecords: ISequence[] = [];
    ...
    constructor(private router: Router, private messageService: MessageService, private recordService: SequenceService, private breadcrumbService: AppBreadcrumbService) {
