...
export class BscPedalCycleService extends CrudService<any> {


  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/bsc-pedal-cycle-cover`, http, accountService,{ populate: ["quoteId",  'signageTypeId'] });
  }
