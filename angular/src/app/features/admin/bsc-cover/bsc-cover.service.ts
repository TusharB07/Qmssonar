...
export class BscCoverService extends CrudService<IBscCover> {
  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/bsc-cover`, http, accountService, { populate: ['productId partnerId'] });
  }
  ...
  downloadExcel(imagePath: string) {
    return this.http.post(`${this.baseUrl}/bsc-covers-file-download?imagePath=${imagePath}`,{}, {
        headers: this.accountService.bearerTokenHeader(),
        observe: 'response',
...
getAllCover() {
  return this.http.get<IOneResponseDto<IBulkImportResponseDto>>(`${this.baseUrl}/`, {
      headers: this.accountService.bearerTokenHeader()
  });
}
}
