...
import { BscFireLossOfProfitRoutingModule } from './bsc-fire-loss-of-profit-routing.module';
import { AutoCompleteModule } from 'primeng/autocomplete';

@NgModule({
  declarations: [
    BscFireLossOfProfitListComponent,
    BscFireLossOfProfitFormComponent
  ],
  imports: [
    CommonModule,
    ReactiveFormsModule,
    FormsModule,
    BscFireLossOfProfitRoutingModule,
    ToolbarModule,
    ToastModule,
    TableModule,
    DialogModule,
...
export class BscFireLossOfProfitModule { }
