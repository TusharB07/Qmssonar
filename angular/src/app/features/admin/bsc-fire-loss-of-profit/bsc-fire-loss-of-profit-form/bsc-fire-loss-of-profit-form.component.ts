...
@Component({
  selector: 'app-bsc-fire-loss-of-profit-form',
  templateUrl: './bsc-fire-loss-of-profit-form.component.html',
  styleUrls: ['./bsc-fire-loss-of-profit-form.component.scss']
})
export class BscFireLossOfProfitFormComponent implements OnInit {
  ...
  constructor(
    ...
    private recordService: BscFireLossOfProfitService,
  ...
  ngOnInit(): void {
    ...
    if (this.id !== "new") {
      ...
      this.recordService.get(this.id).subscribe({
        next: (dto: IOneResponseDto<IBscFireLossOfProfitCover>) => {
  ...
  createForm(item?: IBscFireLossOfProfitCover) {
    ...
    this.recordForm = this.formBuilder.group({
      ...
      indmenityPeriod: [item?.indmenityPeriod],
      terrorism: [item?.terrorism],
      auditorsFees: [item?.auditorsFees],
