...
@Component({
  selector: 'app-bsc-signage-list',
  templateUrl: './bsc-signage-list.component.html',
  styleUrls: ['./bsc-signage-list.component.scss']
})
export class BscSignageListComponent implements OnInit {
  ...
  selectedRecord: IBscSignage | null = null;
  /** Represents the user records being deleted. */
  selectedRecords: IBscSignage[] = [];
  ...
  constructor(private router: Router, private messageService: MessageService, private recordService: BscSignageService, private breadcrumbService: AppBreadcrumbService) {
