...
@Component({
  selector: 'app-bsc-fidelity-gurantee-list',
  templateUrl: './bsc-fidelity-gurantee-list.component.html',
  styleUrls: ['./bsc-fidelity-gurantee-list.component.scss']
})
export class BscFidelityGuranteeListComponent implements OnInit {
  ...
  records: IBSCFidelityGurantee[];
  /** Represents the user record being deleted. */
  selectedRecord: IBSCFidelityGurantee | null = null;
  /** Represents the user records being deleted. */
  selectedRecords: IBSCFidelityGurantee[] = [];
  ...
  constructor(private router: Router, private messageService: MessageService, private recordService: BscFidelityGuranteeService, private breadcrumbService: AppBreadcrumbService) {
