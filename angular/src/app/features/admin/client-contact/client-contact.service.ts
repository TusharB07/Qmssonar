...
export class ClientContactService extends CrudService<IClientContact> {
    constructor(protected http: HttpClient, protected accountService: AccountService) {
        super(`${environment.apiUrl}/client-contacts`, http, accountService, { populate: ["clientId"] });
    }

    createFormData(formData: FormData): Observable<IOneResponseDto<IClientContact>> {
        return this.http.post<IOneResponseDto<IClientContact>>(`${this.baseUrl}/`, formData, {
