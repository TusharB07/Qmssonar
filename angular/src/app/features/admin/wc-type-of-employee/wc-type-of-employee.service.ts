...
export class WCTypeOfEmployeeService extends CrudService<IWCTypeOfEmployee> {

  constructor( protected http: HttpClient, protected  accountService: AccountService) { 
    super(`${environment.apiUrl}/wcTypeOfEmployees`, http, accountService,{ populate: [ 'productId', 'partnerId'] })
  }
