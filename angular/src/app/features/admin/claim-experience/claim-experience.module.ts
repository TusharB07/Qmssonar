...
import { ClaimExperienceRoutingModule } from './claim-experience-routing.module';
...
@NgModule({
  declarations: [
    ClaimExperienceListComponent,
    ClaimExperienceFormComponent
  ],
  imports: [
    CommonModule,
...
export class ClaimExperienceModule { }
