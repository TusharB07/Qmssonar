...
@Component({
  selector: 'app-bsc-burglary-and-housebreaking-form',
  templateUrl: './bsc-burglary-and-housebreaking-form.component.html',
  styleUrls: ['./bsc-burglary-and-housebreaking-form.component.scss']
})
export class BscBurglaryAndHousebreakingFormComponent implements OnInit {
  ...
  constructor(
    ...
    private recordService: BscBurglaryAndHousebreakingService,
  ...
  ngOnInit(): void {
    ...
    if (this.id !== "new") {
      ...
      this.recordService.get(this.id).subscribe({
        next: (dto: IOneResponseDto<IBscBurglaryHousebreakingCover>) => {
  ...
  createForm(item?: IBscBurglaryHousebreakingCover) {
    ...
    this.recordForm = this.formBuilder.group({
      ...
      firstLoss: [item?.firstLoss],
      stocks: [item?.stocks],
      otherContents: [item?.otherContents],
      firstLossSumInsured: [item?.firstLossSumInsured],
      rsmd: [item?.rsmd],
      theft: [item?.theft],
      total: [item?.total],
