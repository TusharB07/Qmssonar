...
export class BscBurglaryAndHousebreakingService extends CrudService<any> {


    constructor(protected http: HttpClient, protected accountService: AccountService) {
        super(`${environment.apiUrl}/bsc-burglary-housebreaking-cover`, http, accountService, { populate: ['quoteId quoteLocationOccupancyId burglaryTypeId'] });
    }
    ...
    getBulkImportProps(quoteOptionId: string, onUpload): PFileUploadGetterProps {
        return {
            name: 'excel_upload',
            // Old_Quote
            // url: `${this.baseUrl}/${quoteOptionId}/excel-upload-v2`,
            // New_Quote_Option
