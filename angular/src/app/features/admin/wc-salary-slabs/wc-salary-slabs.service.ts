...
export class SalarySlabsService extends CrudService<ISalarySlabs> {

  constructor( protected http: HttpClient, protected  accountService: AccountService) { 
    super(`${environment.apiUrl}/wcSalarySlabs`, http, accountService,{ populate: ['productId','partnerId'] })
  }
