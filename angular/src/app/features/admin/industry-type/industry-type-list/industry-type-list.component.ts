...
@Component({
  ...
  styleUrls: ["./industry-type-list.component.scss"]
})
export class IndustryTypeListComponent implements OnInit,OnDestroy {
  cols: any[];
  ...
  records: IIndustryType[];
  /** Represents the user record being deleted. */
  selectedRecord: IIndustryType | null = null;
  /** Represents the user records being deleted. */
  selectedRecords: IIndustryType[] = [];
  ...
  constructor(private router: Router, private messageService: MessageService, private recordService: IndustryTypeService, private breadcrumbService: AppBreadcrumbService) {
