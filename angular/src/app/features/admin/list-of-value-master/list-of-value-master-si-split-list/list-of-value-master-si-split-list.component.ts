...
@Component({
  selector: 'app-list-of-value-master-si-split-list',
  templateUrl: './list-of-value-master-si-split-list.component.html',
  styleUrls: ['./list-of-value-master-si-split-list.component.scss']
})
export class ListOfValueMasterSiSplitListComponent implements OnInit,OnDestroy {
  ...
  loadRecords(event: LazyLoadEvent, name?: string) {
    ...
    event['filters']['lovType'] = [
      {
        "value": AllowedListOfValuesMasters.QUOTE_LOCATION_BREAKUP_L1,
        "matchMode": "equals",
        "operator": "or"
      },
      {
        "value": AllowedListOfValuesMasters.QUOTE_LOCATION_BREAKUP_L2,
        "matchMode": "equals",
        "operator": "or"
      },
      {
        "value": AllowedListOfValuesMasters.QUOTE_LOCATION_BREAKUP_L3,
        "matchMode": "equals",
        "operator": "or"
      },
      {
        "value": AllowedListOfValuesMasters.QUOTE_LOCATION_BREAKUP_L4,
        "matchMode": "equals",
        "operator": "or"
      },
    ]
  ...
  createRecord() {
    this.recordService.routeSource.next('si-split-list');
