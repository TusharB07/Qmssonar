...
export class PaymentDetailsListComponent implements OnInit {
  ...
  recordSingularName = "Payments";
  recordPluralName = "Payments";
  modulePath: string = "/backend/admin/payments";
  /** Represents the data being displayed currently */
  records: IPaymentDetails[];
  /** Represents the user record being deleted. */
  selectedRecord: IPaymentDetails | null = null;
  /** Represents the user records being deleted. */
  selectedRecords: IPaymentDetails[] = [];
  ...
  constructor(
    ...
    private recordService: PaymentDetailsService,
