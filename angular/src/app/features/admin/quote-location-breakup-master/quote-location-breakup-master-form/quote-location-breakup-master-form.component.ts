...
@Component({
  selector: 'app-quote-location-breakup-master-form',
  templateUrl: './quote-location-breakup-master-form.component.html',
  styleUrls: ['./quote-location-breakup-master-form.component.scss']
})
export class QuoteLocationBreakupMasterFormComponent implements OnInit {
  id: string;
  mode: FormMode = "new";
  ...
  constructor(
    ...
    private recordService: QuoteLocationBreakupMasterService,
  ...
  createForm(item?: IQuoteLocaitonBreakupMaster) {
    ...
    this.recordForm = this.formBuilder.group({
      ...
      lovId: [item?.lovId, [Validators.required]],
      ...
      quoteLocationOccupancyId: [quoteLocationOccupancy ? { label: quoteLocationOccupancy.locationName, value: quoteLocationOccupancy._id } : null, [Validators.required]],
    });
  }
  ...
  saveRecord() {
    ...
    //   updatePayload['clientLocationId'] = updatePayload.clientLocationId.value;
      updatePayload['quoteLocationOccupancyId'] = updatePayload.quoteLocationOccupancyId.value;
