...
export class BranchMasterService extends CrudService<IBranchMaster> {


  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/BranchMaster`, http, accountService, { populate: [ "partnerId"] });
  }

  // Bulk Import -----------------------------------------------------------------------------------------
  bulkImportGenerateSample(payload :any) {
    return this.http.post<IOneResponseDto<IBulkImportResponseDto>>(`${this.baseUrl}/BranchMaster`,payload , {
