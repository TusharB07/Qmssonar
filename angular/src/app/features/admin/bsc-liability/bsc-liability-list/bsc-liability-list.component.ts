...
@Component({
  selector: 'app-bsc-liability-list',
  templateUrl: './bsc-liability-list.component.html',
  styleUrls: ['./bsc-liability-list.component.scss']
})
export class BscLiabilityListComponent implements OnInit {

  cols: any[];

  recordSingularName = "BSC Liability";
  recordPluralName = "BSC Liabilities";
  modulePath: string = "/backend/admin/bsc-liability-section-cover";
  /** Represents the data being displayed currently */
  records: IBscLiability[];
  /** Represents the user record being deleted. */
  selectedRecord: IBscLiability | null = null;
  /** Represents the user records being deleted. */
  selectedRecords: IBscLiability[] = [];
  ...
  constructor(private router: Router, private messageService: MessageService, private recordService: BscLiabilityService, private breadcrumbService: AppBreadcrumbService) {
