...
export class DeteriorationOfStocksInACoverService extends CrudService<any> {

 
  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/bscDeteriorationOfStocksInACover`, http, accountService,{ populate: ["quoteId"] });
  }
