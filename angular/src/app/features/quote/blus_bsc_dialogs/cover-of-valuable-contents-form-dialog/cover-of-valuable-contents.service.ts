...
export class CoverOfValuableContentsService extends CrudService<any> {

 
  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/bscValuableContentsCover`, http, accountService,{ populate: ["quoteId"] });
  }
