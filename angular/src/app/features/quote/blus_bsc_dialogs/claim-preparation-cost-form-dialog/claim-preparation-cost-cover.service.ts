...
export class ClaimPreparationCostCoverService extends CrudService<any> {

 
  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/bscClaimPreparationCostCover`, http, accountService,{ populate: ["quoteId"] });
  }
