...
export class InsurenceOfAdditionalExpenseCoverService extends CrudService<any> {

 
  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/bscInsurenceOfAdditionalExpenseCover`, http, accountService,{ populate: ["quoteId"] });
  }
