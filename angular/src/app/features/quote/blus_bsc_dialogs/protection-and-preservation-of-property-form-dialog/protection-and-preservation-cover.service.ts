...
export class ProtectionAndPreservationCoverService extends CrudService<any>{

  
  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/bscProtectionAndPreservationCover`, http, accountService,{ populate: ["quoteId"] });
  }
