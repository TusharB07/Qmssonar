...
export class InvoluntaryBettermentCoverService extends CrudService<any> {

 
  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/bscInvoluntaryBettermentCover`, http, accountService,{ populate: ["quoteId"] });
  }
