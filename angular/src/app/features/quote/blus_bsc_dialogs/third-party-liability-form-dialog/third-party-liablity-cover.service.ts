...
export class ThirdPartyLiablityCoverService extends CrudService<any>{

 
  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/bscThirdPartyLiablityCover`, http, accountService,{ populate: ["quoteId"] });
  }
