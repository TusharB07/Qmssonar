...
export class TenantsLegalLiablityCoverService extends CrudService<any>{


  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/bscTenantsLegalLiablityCover`, http, accountService,{ populate: ["quoteId"] });
  }
