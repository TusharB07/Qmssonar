...
export class BscWorkmenCompensationService extends CrudService<any> {

  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/bsc-workmen-compensation-cover`, http, accountService, { populate: ["quoteId", 'riskTypeId'] });
  }
