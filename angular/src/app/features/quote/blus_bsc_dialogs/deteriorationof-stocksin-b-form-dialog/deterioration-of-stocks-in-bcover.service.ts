...
export class DeteriorationOfStocksInBCoverService extends CrudService<any> {

 
  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/bscDeteriorationOfStocksInBCover`, http, accountService,{ populate: ["quoteId"] });
  }
