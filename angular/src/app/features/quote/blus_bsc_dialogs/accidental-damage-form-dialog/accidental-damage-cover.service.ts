...
export class AccidentalDamageCoverService extends CrudService<any> {

 
  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/bscAccidentalDamageCover`, http, accountService,{ populate: ["quoteId"] });
  }
