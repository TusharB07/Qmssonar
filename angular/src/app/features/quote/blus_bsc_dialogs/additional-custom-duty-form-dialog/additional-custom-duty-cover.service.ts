...
export class AdditionalCustomDutyCoverService extends CrudService<any> {

 
  constructor(protected http: HttpClient, protected accountService: AccountService) {
    super(`${environment.apiUrl}/bscAdditionalCustomDutyCover`, http, accountService,{ populate: ["quoteId"] });
  }
