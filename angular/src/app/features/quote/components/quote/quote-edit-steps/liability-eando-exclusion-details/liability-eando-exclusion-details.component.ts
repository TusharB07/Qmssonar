...
@Component({
  selector: 'app-liability-eando-exclusion-details',
  templateUrl: './liability-eando-exclusion-details.component.html',
  styleUrls: ['./liability-eando-exclusion-details.component.scss']
})
export class LiabilityEandOExclusionDetailsComponent implements OnInit {
