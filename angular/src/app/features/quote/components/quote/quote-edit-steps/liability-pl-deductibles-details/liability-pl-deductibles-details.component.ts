...
@Component({
  selector: 'app-liability-pl-deductibles-details',
  templateUrl: './liability-pl-deductibles-details.component.html',
  styleUrls: ['./liability-pl-deductibles-details.component.scss']
})
export class LiabilityProductliabilityDeductiblesComponent implements OnInit {
  ...
  constructor(private dialogService: DialogService, private messageService: MessageService, private accountService: AccountService, private quoteService: QuoteService, private liabilityProductTemplateService: liabilityProductTemplateService) {
  ...
  save() {
    ...
    let totalIndictiveQuoteAmtWithGst = Number(this.quotePLOptions.totalPremiumAmt * 0.18)
