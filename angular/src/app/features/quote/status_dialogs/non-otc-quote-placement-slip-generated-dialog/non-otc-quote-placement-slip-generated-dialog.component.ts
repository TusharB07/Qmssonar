...
@Component({
    selector: 'app-non-otc-quote-placement-slip-generated-dialog',
    templateUrl: './non-otc-quote-placement-slip-generated-dialog.component.html',
    styleUrls: ['./non-otc-quote-placement-slip-generated-dialog.component.scss']
})
export class NonOtcQuotePlacementSlipGeneratedDialogComponent implements OnInit {
    ...
    makePayment() {
        ...
        // this.router.navigateByUrl(`backend/create-client`)
