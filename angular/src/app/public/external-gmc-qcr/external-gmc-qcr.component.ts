...
import { IQuoteSlip, IQuoteGmcTemplate, IEmployeesDemoSummary, AllowedQuoteStates } from 'src/app/features/admin/quote/quote.model';
import { QuoteService } from 'src/app/features/admin/quote/quote.service';
import { IUser } from 'src/app/features/admin/user/user.model';
import { CoInsuranceFormDialogGmcComponent } from 'src/app/features/quote/components/co-insurance-form-dialog-gmc/co-insurance-form-dialog-gmc.component';
import { PaymentDetailGmcComponent } from 'src/app/features/quote/components/payment-detail-gmc/payment-detail-gmc.component';
import { QuoteSlipDialogComponent } from 'src/app/features/quote/components/quote-slip-dialog/quote-slip-dialog.component';
import { GMCFileUploadDialogComponent } from 'src/app/features/quote/components/quote/gmc-file-upload-qcr-dialog/gmc-file-upload-qcr-dialog.component';
import { ComparasionwithBrokerModel, IcOptions, QCRQuestionAnswer, QcrHeaders, QcrAnswers } from 'src/app/features/quote/pages/quote-comparision-review-detailed-page-gmc/quote-comparasion-review-detailed-page.model';
import * as XLSX from 'xlsx';
import jsPDF from 'jspdf';
import html2canvas from 'html2canvas';

@Component({
  selector: 'app-external-gmc-qcr',
  templateUrl: './external-gmc-qcr.component.html',
  styleUrls: ['./external-gmc-qcr.component.scss']
})
export class ExternalGmcQcrComponent implements OnInit {
  id: string;
  quote: IQuoteSlip;
  sendLinkForm: any;
      ...
      brokerQuote.allCoversArray.gmcOptions.filter(x => x.version == this.selectedVersion).forEach(element => {
          ...
          element.gmcTemplateData.forEach(tempdata => {
              ...
              tempdata.gmcSubTab.forEach(gmcsTab => {
                  ...
                  this.qmodel.gmcLabelForSubTabId = 0;
                  this.qmodel.questId = 0;
                  this.qmodel.isHeader = false;
                  this.qmodel.isSubHeader = false;
                  this.qmodel.isLabel = true;
                  this.qmodel.parentTabName = "Test"
                  //Answer Broker Ans
                  ...
                  qcrAnswers.id = 0;
                  qcrAnswers.optionIndex = 0

                  //Answer Broker Question
                  this.qmodel.parentTabName = "sfsfsfsf"
                  this.qmodel.question = "sfsfsfsf";
                  this.qmodel.answer.push(qcrAnswers);

                  //Search in answer array and add answer
                  this.questionAnswerList[0].answer.push(qcrAnswers)
  ...
  generateqcrEdit(quoteId: string) {
      const payload = {};
      payload["pushBackFrom"] = AllowedPushbacks.QCR;
